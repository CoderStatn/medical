            ...
            <Navbar bg="light" expand="lg">
              <Container>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                      ...
                      <Nav.Link className='' href="#about">About Dr Bryan</Nav.Link>
                      <Nav.Link className='' href="#services">Services</Nav.Link>
                      <Nav.Link className='' href="#testimonial">Testimonial</Nav.Link>
                      <Nav.Link className='' href="#blog">Blog</Nav.Link>
                      <Nav.Link className='' href="#booking">Book a visit</Nav.Link>
                      <Navbar.Text>

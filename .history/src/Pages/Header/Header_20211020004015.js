            ...
            <Navbar bg="light" expand="lg">
              <Container>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                      ...
                      <Nav.Link as={Link} href="#about">About Dr Bryan</Nav.Link>
                      <Nav.Link as={Link} href="#services">Services</Nav.Link>
                      <Nav.Link as={Link} href="#testimonial">Testimonial</Nav.Link>
                      <Nav.Link as={Link} href="#blog">Blog</Nav.Link>
                      <Nav.Link as={Link} href="#booking">Book a visit</Nav.Link>
                      <Navbar.Text>

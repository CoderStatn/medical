            ...
            <Container fluid>
                <Row>
                    <div className="col-12 col-md-6">
                        ...
                        <p>Vivamus pretium pellentesque vestibulum. In mollis, elit vitae rhoncus pellentesque, arcu quam imperdiet ex, vitae congue tellus turpis sed tortor. Morbi consequat vel dolor quis venenatis. Aenean non interdum purus. Maecenas sem nunc, ullamcorper sit amet nulla quis, porta pharetra velit. Nam eros nisl, consequat sit amet pharetra. <br /> Proin congue in neque at mollis. Suspendisse eros nulla, vehicula id sollicitudin ut, feugiat sit amet ligula. Integer posuere purus lorem, id bibendum ante commodo et. Nunc ut quam ut eros accumsan eleifend. Curabitur vitae tristique augue. Morbi vitae semper lorem, id sagittis lectus.
</p>
                    </div>
                    <div className="col-12 col-md-6">

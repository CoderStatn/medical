...
const Register = () => {
  const { handleEmailChange, handlePasswordChange, handleRegister, error } = useFirebase();
    return (
        <div>
                    ...
                    <Col md className='my-auto'>
                      <Form onSubmit={handleRegister}>
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                          <Form.Control onBlur={handleNamwChange} type="email" placeholder="Enter your email" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicEmail">
